...
(function () {
  ...
  function buildFlip() {
    ...
    function layout() {
      els.forEach(function (d, i) {
        ...
        d.style.zIndex = turned ? (100 + i) : (i === flipCur ? 50 : (N - i));
      });
  ...
  function initCall() {
    ...
    function reveal(b){
      var tel=dec(b.getAttribute("data-c")), disp=dec(b.getAttribute("data-d"));
      b.textContent=disp; b.setAttribute("data-de",disp); b.setAttribute("data-en",disp); b.setAttribute("data-revealed","1");
